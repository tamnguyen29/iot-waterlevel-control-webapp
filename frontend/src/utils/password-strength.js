...
export const lengthIndicator = (strength) => {
  const weakLength = 62;
  if (strength < 2) return weakLength;
  if (strength < 3) return weakLength * 2;
  if (strength < 4) return weakLength * 3;
  if (strength < 5) return weakLength * 4;
  if (strength < 6) return weakLength * 5;
  return weakLength;
};
