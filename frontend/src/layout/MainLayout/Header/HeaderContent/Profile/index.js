...
const Profile = () => {
  ...
  const handleLogout = async () => {
    await services.logoutAPI(jwtAxios, dispatch, loginUser.user.id);
  };
      ...
      >
        <Stack direction="row" spacing={2} alignItems="center" sx={{ p: 0.5 }}>
          <StyledBadge overlap="circular" anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }} variant="dot">
            <Avatar alt="profile user" sx={{ width: 32, height: 32 }} src={user.avatar === 'DEFAULT' ? DefaultAvatar : user.avatar} />
          </StyledBadge>
                        ...
                        <Grid item>
                          <Stack direction="row" spacing={1.25} alignItems="center">
                            <Avatar
                              ...
                              src={user.avatar === 'DEFAULT' ? DefaultAvatar : user.avatar}
                            />
